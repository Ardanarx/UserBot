...
async def reedme(event):
    await event.edit(
        ...
        "\n[One4uBot's README.md file](https://github.com/ardanarx/Userbot/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        ...
        "[Click here](https://github.com/ardanarx/Userbot) to open One4uBot's GitHub page."
    )
